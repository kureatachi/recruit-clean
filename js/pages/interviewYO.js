...
function initCenterCarousel() {
  ...
  console.log('interviewYO: Found', centerCarouselItems.length, 'carousel items');
...
(function() {
  function init() {
    console.log('interviewYO: Initializing carousel, readyState:', document.readyState);
  ...
  document.addEventListener('DOMContentLoaded', function() {
    console.log('interviewYO: DOMContentLoaded fired');
    setTimeout(init, 50);
  });
  
  // Backup: try on window load
  window.addEventListener('load', function() {
    console.log('interviewYO: window.load fired, items:', centerCarouselItems.length);
    if (centerCarouselItems.length === 0) {
      setTimeout(init, 50);
    }
  });
